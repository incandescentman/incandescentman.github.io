...
But we're not in the 12th century anymore. Google Calendar is not a paper calendar. On your laptop or iPad, you can read books in *Continuous Scroll mode*. Instead of requiring you to manually turn the page every ten paragraphs, you can just hit the down arrow to read on.

That's the experience I want for a calendar: *A continuous scroll mode, but for time.*
