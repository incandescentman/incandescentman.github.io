...
** Practice: Creating a hierarchical document structure :slide:darkbloom:
...
** converting question method to an outline

** Question method                     :slide:
...
(Incidentally, if the actual writing of these documents is done in Google Drive, I advise students to turn on [[https://i.imur.com/dNTxas2.png][Document Outline Mode]] to make it easy to see the logical structure as you're creating it.)

I reorganized the document so as to make the structure more logical and explicit. Here's a before/after.

*** sanity checks: are they parallel with each other?

*** use of a colon: like this

*** longer, more informative headings are better

*** if it's a recommendation, it should start with a verb


* 1:00–10:30
** TODO The intrasection question method :slide:
Learning objective
Use the question method to define the key points *within
*each section*
...
** all documents should be FAQ's
You don't have to include the questions
- every section should be answering a question

*** How do I use the question method to define key points? :slide:
*** Practice: what am I saying in each of these paragraphs? :slide:
*** Debrief :slide:

* Significance - telling the reader why they're reading what they're reading
** TODO Never make the reader read something without telling them why it's important.
...
1. Topic sentences
2. Tell the reader why they need to do this
...
*** Vague language
Throughout the document, there's a lot of vague and confusing language. Here are a few examples.

: "Redfin does not meaningfully identify relocatees"

What does it mean to identify them meaningfully? How is this different from simply identifying them?

: "We don't cleanly service a client who has worked with Redfin in one market and wants to buy in another."

What does it mean to service these customers "cleanly"? That's not a standard term and it's not clear what it means. I think what this sentence is really trying to say is this: "We don't provide an easy way for clients who have already worked with Redfin in one city to start working with us again in their new city when they start looking to buy a place."
...
The objective isn't to notice these things so that you never need to trim in the future. The objective is to add trimmin to your checklist of things to do. It's necessary step. You always need to trim.
